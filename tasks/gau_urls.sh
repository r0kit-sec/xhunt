...
echo $SUBDOMAIN | gau --blacklist jpg,jpeg,gif,css,tif,tiff,png,ttf,woff,woff2,ico,svg,webp --subs --timeout 120 --fc 404,302,301 | uro | httpx -H "User-Agent: $USER_AGENT" | anew $URLS_DESTINATION
